    ...
    >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" id="data_inicio_traducao" name="data_inicio_traducao" value="<?php echo htmlspecialchars($formData['data_inicio_traducao'] ?? date('Y-m-d')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-orange-500 focus:border-orange-500">
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div id="deadline-days-wrapper" class="<?php echo $deadlineType === 'data' ? 'hidden' : ''; ?>">
                ...
                <input type="number" min="1" id="traducao_prazo_dias" name="traducao_prazo_dias" value="<?php echo htmlspecialchars($formData['traducao_prazo_dias'] ?? ''); ?>" class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-orange-500 focus:border-orange-500" data-deadline-days>
            </div>
            <div id="deadline-date-wrapper" class="<?php echo $deadlineType === 'data' ? '' : 'hidden'; ?>">
                ...
                <input type="date" id="traducao_prazo_data" name="traducao_prazo_data" value="<?php echo htmlspecialchars($formData['traducao_prazo_data'] ?? ''); ?>" class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-orange-500 focus:border-orange-500" data-deadline-date>
            </div>
        </div>
