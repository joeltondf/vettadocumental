...
<div class="flex flex-col lg:flex-row gap-6 mb-8">
    ...
    <div class="w-full lg:w-[15%]">
        <div class="grid grid-cols-1 sm:grid-cols-1 gap-4">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
                ...
                <div class="ml-2"><p class="text-gray-500 text-sm">Orçamentos Pendentes</p><p class="text-2xl font-bold text-gray-800"><?php echo $dashboardStats['orcamentos_pendentes'] ?? 0; ?></p></div>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
                ...
                <div class="ml-2"><p class="text-gray-500 text-sm">Serviços Atrasados</p><p class="text-2xl font-bold text-gray-800"><?php echo $dashboardStats['processos_atrasados'] ?? 0; ?></p></div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-[50%] bg-white p-5 rounded-lg shadow-xl border border-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="processes-table-body">
                    <?php foreach ($processos as $processo): ?>
                        ...
                        <tr class="<?php echo $rowClass; ?>">
                            ...
                            <td class="px-3 py-1 whitespace-nowrap text-xs text-gray-500"><?php echo isset($processo['data_criacao']) ? date('d/m/Y', strtotime($processo['data_criacao'])) : 'N/A'; ?></td>
                            <td class="px-3 py-1 whitespace-nowrap text-xs text-gray-500"><?php echo isset($processo['data_inicio_traducao']) ? date('d/m/Y', strtotime($processo['data_inicio_traducao'])) : 'N/A'; ?></td>
                            <td class="px-3 py-1 whitespace-nowrap text-xs font-medium">
                                <?php
